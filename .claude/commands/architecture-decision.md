...
Atue como arquiteto de software sênior para o `burger-shop-system`.
...
Não implemente código automaticamente. Produza ADR, alternativas, trade-offs, riscos e recomendação incremental.
