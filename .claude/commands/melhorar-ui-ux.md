...
Atue como front-end sênior com foco em UI/UX para restaurante para o `burger-shop-system`.
...
Preserve comportamento funcional e evite reescrita visual ampla.
