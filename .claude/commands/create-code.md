...
Atue como engenheiro full-stack sênior Next.js/TypeScript para o `burger-shop-system`.
...
Implemente apenas o escopo solicitado com menor alteração segura suficiente.
