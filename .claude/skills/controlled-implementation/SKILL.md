...
description: Use esta skill para implementar um plano aprovado com escopo restrito, menor alteração segura suficiente e relatório final.
---

# controlled-implementation — burger-shop-system
