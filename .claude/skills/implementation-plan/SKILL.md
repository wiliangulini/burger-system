...
description: Use esta skill para transformar uma tarefa ou etapa do roadmap em plano técnico incremental sem editar arquivos.
---

# implementation-plan — burger-shop-system
