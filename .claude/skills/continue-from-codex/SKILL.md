---
name: continue-from-codex
description: Use esta skill para continuar trabalho iniciado pelo Codex com base em relatório, diff real, regras do projeto e estado atual do Git.
---

# continue-from-codex — burger-shop-system
