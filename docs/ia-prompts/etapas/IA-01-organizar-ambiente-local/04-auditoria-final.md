# IA-01 — Organizar ambiente local e workspace de agentes — 04-auditoria-final
...
Atue como auditor final da etapa `IA-01`. Verifique se a etapa está segura, completa, rastreável e pronta para avançar.
...
```md
# Relatório de auditoria final — IA-01 — Organizar ambiente local e workspace de agentes
