# IA-01 — Organizar ambiente local e workspace de agentes — 03-correcao-pos-revisao
...
Corrigir somente os problemas apontados no relatório de revisão da etapa `IA-01`.
...
```md
# Relatório de correção pós-revisão — IA-01 — Organizar ambiente local e workspace de agentes
