# IA-01 — Organizar ambiente local e workspace de agentes — 02-revisao
...
Atue como Agente Auditor de Segurança. Revise a entrega feita por Agente Técnico/Dev.
...
Compare a execução com o bloco `IA-01` do `roadmap-execucao-ia.md`.
...
```md
# Relatório de revisão — IA-01 — Organizar ambiente local e workspace de agentes
