# IA-02 — Criar regras de segurança, permissões e limites — 02-revisao
...
Atue como Agente Técnico/Dev. Revise a entrega feita por Agente Auditor de Segurança.
...
Compare a execução com o bloco `IA-02` do `roadmap-execucao-ia.md`.
...
```md
# Relatório de revisão — IA-02 — Criar regras de segurança, permissões e limites
