# IA-02 — Criar regras de segurança, permissões e limites — 04-auditoria-final
...
Atue como auditor final da etapa `IA-02`. Verifique se a etapa está segura, completa, rastreável e pronta para avançar.
...
```md
# Relatório de auditoria final — IA-02 — Criar regras de segurança, permissões e limites
